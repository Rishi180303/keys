...
def push(src, bucket: str, prefix: str, s3=None) -> list[str]:
    ...
    for f in files:
        ...
        keys.append(push_file(f, bucket, prefix.rstrip("/") + "/" + rel, s3=s3))
    return keys


def push_file(path, bucket: str, key: str, s3=None) -> str:
