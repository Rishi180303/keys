...
**Interfaces:**
- Consumes: `KEY` from `keys.data`, so Task 3 must land before this task runs. Order the execution 1, 3, 2, 4 or add `KEY = ["game_id", "play_id", "nfl_id"]` locally and switch to the import in Task 3.
